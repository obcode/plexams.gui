...
- **Endschalter `compilerOptions.runes: true`**: nach sv migrate sind ~alle Komponenten runes; prüfen ob wirklich alle, dann global einschalten → erzwingt Runes, verbliebene Legacy-Stelle = Compile-Fehler.
