...
<div class="text-center m-2 text-4xl">
	<span class="uppercase"
		>{zpaExamsToPlanWithConstraints.filter((exam) => exam.constraints).length} ZPA-Prüfungen mit Constraints</span
	>
</div>

<ConstraintsTable examsWithConstraints={zpaExamsToPlanWithConstraints} />
